...
public class ConnectorsResource {
  ...
  public Response createConnector(final @QueryParam("forward") Boolean forward,
    ...
    Herder.Created<ConnectorInfo> info = completeOrForwardRequest(cb, "/connectors", "POST",
        headers, createRequest,
  ...
  public Map<String, String> getConnectorConfig(final @PathParam("connector") String connector,
    ...
    return completeOrForwardRequest(cb, "/connectors/" + connector + "/config", "GET", headers,
        null, forward);
  }
  ...
  public Response resetConnectorActiveTopics(final @PathParam("connector") String connector,
      final @Context HttpHeaders headers) {
    if (isTopicTrackingDisabled) {
      throw new ConnectRestException(Response.Status.FORBIDDEN.getStatusCode(),
          "Topic tracking is disabled.");
  ...
  public Response putConnectorConfig(final @PathParam("connector") String connector,
    ...
    Herder.Created<ConnectorInfo> createdInfo = completeOrForwardRequest(cb,
  ...
  public void restartConnector(final @PathParam("connector") String connector,
    ...
    completeOrForwardRequest(cb, "/connectors/" + connector + "/restart", "POST", headers, null,
        forward);
  }
  ...
  public List<TaskInfo> getTaskConfigs(final @PathParam("connector") String connector,
    ...
    return completeOrForwardRequest(cb, "/connectors/" + connector + "/tasks", "GET", headers, null,
  ...
  public void putTaskConfigs(final @PathParam("connector") String connector,
    ...
    List<Map<String, String>> taskConfigs = new ObjectMapper()
        .readValue(requestBody, TASK_CONFIGS_TYPE);
    FutureCallback<Void> cb = new FutureCallback<>();
  ...
  public void restartTask(final @PathParam("connector") String connector,
    ...
    completeOrForwardRequest(cb, "/connectors/" + connector + "/tasks/" + task + "/restart", "POST",
  ...
  private void checkAndPutConnectorConfigName(String connectorName,
    ...
    if (includedName != null) {
      if (!includedName.equals(connectorName)) {
        throw new BadRequestException("Connector name configuration (" + includedName
      ...
      if (cause instanceof RequestTargetException) {
        if (forward == null || forward) {
          ...
          return translator.translate(
              RestClient.httpRequest(forwardUrl, method, headers, body, resultType, config));
        } else {
  ...
  private static class CreatedConnectorInfoTranslator implements
    ...
    @Override
    public Herder.Created<ConnectorInfo> translate(
        RestClient.HttpResponse<ConnectorInfo> response) {
